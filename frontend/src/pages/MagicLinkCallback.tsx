...
export default function MagicLinkCallback() {
  ...
  useEffect(() => {
    const verify = async () => {
      ...
      const email = searchParams.get('email') || sessionStorage.getItem('magicLinkEmail');
      ...
      try {
        ...
        setStatus('error');
        setErrorMessage(err.response?.data?.error || err.message || 'Failed to verify magic link');
      }
    };
